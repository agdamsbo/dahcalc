...
library(DAHcalc)     # <- the package we are documenting
...
# head(synthetic_data)
synthetic_data <- DAHcalc::synthetic_data
```
...
my_dt <- data.table::copy(synthetic_data)
...
```{r eval=FALSE}
my_real_data <- fread("my_clinical_file.csv")
